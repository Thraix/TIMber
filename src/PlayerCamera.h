...
class PlayerCamera : public Greet::Camera
{
  private:
    ...
    Movement movement;
  public:
    PlayerCamera(const Greet::Mat4& projectionMatrix, const Greet::Vec3<float>& position, float pitch, float yaw) 
      : Camera{projectionMatrix}, position{position}, rotation{pitch, yaw, 0}, 
